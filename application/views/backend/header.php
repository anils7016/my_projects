...
<head>
  ...
  <title>Knowleddge Hub Global</title>
  <!-- Favicon -->
  ...
  <link type="text/css" href="<?= base_url();?>/assets/css/dataTables.bootstrap4.min.css" rel="stylesheet">
</head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('backend/category');?>">
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
              ...
              <div class="dropdown-divider"></div>
              <a href="<?= site_url('backend/logout');?>" class="dropdown-item">
                <i class="ni ni-user-run"></i>
                <span>Logout</span>
              </a>
            </div>
