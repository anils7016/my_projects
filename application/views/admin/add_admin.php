            ...
            <div class="pl-lg-4">
                ...
                <div class="col-md-12">
                  <div class="form-group focused">
                    ...
                    <input class="form-control form-control-alternative" placeholder="Name" name="name" type="text" required>
                  </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-12">
                    <div class="form-group focused">
                      ...
                      <input class="form-control form-control-alternative" placeholder="Email" name="email" type="email" required="">
                    </div>
                  </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group focused">
                    ...
                    <input class="form-control form-control-alternative" placeholder="Password" name="password" type="password" required="">
                  </div>
                </div>
              </div>
