		  ...
		  <div class="row">
              <div class="col-sm-12 text-center pt-8 pt-md-4 pb-0 pb-md-4">
                <div class="ag-img card-profile-image">
                    <?php if(!empty($com->image)) { $image = $com->image; } else { $image = base_url().'assets/experts/experts.png';} ?>
                    <img src="<?= $image; ?>">
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group focused">
                    ...
                    <input class="form-control form-control-alternative" placeholder="Experts Name" name="expert_name" type="text" required value="<?= $com->expert_name; ?>">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group focused">
                    ...
                    <input class="form-control form-control-alternative" placeholder="Experts Image" name="image" type="file">
                  </div>
                </div>
              </div>
