...
class Ajax_pagination{
    ...
    var $num_links       =  2;
    var $cur_page        =  0;
    var $first_link      = '<i class="fa fa-chevron-left" aria-hidden="true"></i>';
    var $next_link       = '&#187;';
    var $prev_link       = '&#171;';
    var $last_link       = '<i class="fa fa-chevron-right" aria-hidden="true"></i>	';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="pagination-listing"><ul class="pagination">';
    var $full_tag_close  = '</ul></div>';
    var $first_tag_open  = '';
    var $first_tag_close = '';
    var $last_tag_open   = '';
    var $last_tag_close  = '';
    var $cur_tag_open    = '<a href="#">';
    var $cur_tag_close   = '</a>';
    var $next_tag_open   = '';
    var $next_tag_close  = '';
    var $prev_tag_open   = '';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
             $sds = '<span class="title-pagination-result">'.$this->total_rows . ' Search reasults </span>';
            return $sds;
        }
        ...
        for ($loop = $start -1; $loop <= $end; $loop++){
            ...
            if ($i >= 0){
                if ($this->cur_page == $loop){
                    $output .= '<li class="page-item active">'.$this->cur_tag_open.$loop.$this->cur_tag_close.'</li>'; // Current page
                }else{
                    $n = ($i == 0) ? '' : $i;
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<li class="page-item"><a href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.')">'. $text .'</a></li>';
    }
}